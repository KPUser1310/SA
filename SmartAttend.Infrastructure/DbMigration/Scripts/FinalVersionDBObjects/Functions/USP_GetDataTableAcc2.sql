-- FUNCTION: public.usp_getdatatableacc2(integer, bigint, integer, integer)

-- DROP FUNCTION IF EXISTS public.usp_getdatatableacc2(integer, bigint, integer, integer);

CREATE OR REPLACE FUNCTION public.usp_getdatatableacc2(
	p_accountid integer,
	p_deviceid bigint,
...
ALTER FUNCTION public.usp_getdatatableacc2(integer, bigint, integer, integer)
