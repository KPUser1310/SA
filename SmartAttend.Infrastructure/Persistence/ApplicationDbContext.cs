...
using SmartAttend.Domain.Interface;    
    ...
    public class ApplicationDbContext : BaseDbContext<ApplicationDbContext>, IApplicationDbContext
    {
     ...
     //   public DbSet<BaseEntity> BaseEntities { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // BaseDbContext handles CreatedAt/LastModifiedAt
            base.OnModelCreating(builder);

            // TODO: Apply entity-specific configurations here
            // builder.ApplyConfiguration(new SomeEntityConfiguration());
        }
